        ...
        <div class="flex flex-col md:flex-row justify-between items-center w-full space-y-8 md:space-y-0 md:space-x-16">
            ...
            <div class="flex flex-col items-center text-center flex-1">
                ...
                <ul class="flex flex-col items-center">
                    <li><a href="/" class="text-base text-green-400 hover:text-primary mb-4">Home</a></li>
                    <li><a href="/" class="text-base text-green-400 hover:text-primary mb-4">Sobre Nosotros</a></li>
                    <li><a href="/" class="text-base text-green-400 hover:text-primary mb-4">Contacto</a></li>
            ...
            <div class="flex flex-col items-center text-center flex-1">
                ...
                <p class="text-base text-green-400 mb-6">Recibe novedades y actualizaciones sobre proyectos ecológicos y
                    más.</p>
