<footer class="wow fadeInUp relative z-10 bg-primary bg-opacity-5 pt-16 md:pt-20 lg:pt-24" data-wow-delay=".1s">
    <div class="container">
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
          <div class="mb-12 max-w-[360px] lg:mb-16">
            ...
            <div class="flex items-center">
              <a href="/" aria-label="social-link" class="mr-6 text-[#CED3F6] hover:text-primary">
