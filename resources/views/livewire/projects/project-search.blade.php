<div class="mx-auto max-w-[1100px] p-3 flex flex-col gap-8">
   ...
   {{--  <div class="mb-6 flex items-center justify-center">
        <input type="text" wire:model.live='query'
            class="w-full max-w-lg px-6 py-3 text-lg rounded-xl border-2 border-gray-300  text-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-400 transition-all"
            placeholder="Buscar proyectos...">
    </div> --}}
            ...
            <div class="p-6">
                ...
                <div class="flex justify-between items-center">
                    <a href="{{ route('project.detail', $project->id) }}"
                        class="bg-green-600 px-4 py-2 rounded-md font-light hover:bg-green-500 transition-colors duration-300">
                        Ver más
                    </a>
